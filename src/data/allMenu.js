export const menu = [
  {
    name: "Campus",
    icon: "campus",
    description: "A unique, exclusive space for college students on Social Connect.",
  },
  {
    name: "Events",
    icon: "events",
  ...
  },
  {
    name: "Pages",
    icon: "pages",
    description: "Discover and connect with businesses on Social Connect.",
  },
  {
    name: "Gaming Video",
    icon: "gaming",
  ...
  },
  {
    ...
    icon: "recent",
    description: "See all the ads you interacted with on Social Connect.",
  },
  {
    name: "Memories",
    icon: "memories",
    description: "Browse your old photos, videos and posts on Social Connect.",
  },
  {
    name: "Saved",
    icon: "saved",
